...
成功注册域之后，这些域会保留所选的时间长度。可以使用客户门户网站对其进行管理。域的注册时间段到期后，可通过[客户门户网站 ![外部链接图标](../../icons/launch-glyph.svg "外部链接图标")](https://{DomainName}/) 来[更新](/docs/infrastructure/dns?topic=dns-renew-multiple-existing-domains)到期的域。
